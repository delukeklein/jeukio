...
public class FolderMakerAndOrganizer : EditorWindow
{
    ...
    ///Known issues :
    /// if you make a folder thats already there it will make an extra one with a 1/2/3 after i. fix is on its way.
    /// everytime you click a organize button it will organize all the .insertFileExtentions you are trying to organize ( this costs preformance issues ) Fix is on its way. 
